...
public class DataInput implements CommandLineRunner {
    ...
    private void createSellers(){
        Seller seller = new Seller("Meron Tedros ", true, null);
        Set<Role> roleSet = new HashSet<>();
        roleSet.add(roleRepository.findById(2L).get());
        seller.setUsername("meron");
    ...
    private void createBuyers(){
        Buyer buyer = new Buyer(0,"Helen Teklemariam",null,null,null,null,null);
        Set<Role> roleSet = new HashSet<>();
        roleSet.add(roleRepository.findById(3L).get());
        buyer.setUsername("helen");
...
//        buyerService.addReviewByBuyerId(review1,6, 8);
    ...
    private void createAddress(){
        ...
        address2.setCountry("UAE");
        address2.setCity("Khalifa City");
        address2.setState("Abu Dhabi");
